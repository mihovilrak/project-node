...
type MembershipCheck = (pool: Pool, id: string, userId: string) => Promise<boolean>;
...
const fromKey = (key: string): IdResolver => (req) => {
...
export const requireTaskAccessBy = (pool: Pool, resolveId: IdResolver): RequestHandler =>
  guard(pool, resolveId, isTaskProjectMember);
