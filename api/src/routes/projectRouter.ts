...
export default function projectRouter(pool: DatabasePool): Router {
  ...
  router.post('/',
    ...
    (req, res) => projectController.createProject(req, res, pool)
  );

  // Change project status route
  router.patch('/:id/status',
    checkPermission(pool, 'Edit projects'),
    (req, res) => projectController.changeProjectStatus(req, res, pool)
  );

  // Update project route
  router.put('/:id',
    checkPermission(pool, 'Edit projects'),
    (req, res) => projectController.updateProject(req, res, pool)
  );

  // Delete project route
  router.delete('/:id',
    checkPermission(pool, 'Delete projects'),
    (req, res) => projectController.deleteProject(req, res, pool)
  );
  ...
  router.post('/:id/members',
    checkPermission(pool, 'Create projects'),
    (req, res) => projectController.addProjectMember(req, res, pool)
  );

  // Delete project member
  router.delete('/:id/members',
    checkPermission(pool, 'Edit projects'),
    (req, res) => projectController.deleteProjectMember(req, res, pool)
  );
