...
export default (pool: Pool): Router => {
  ...
  router.post(
    ...
    withPool(pool, activityTypeController.createActivityType),
  );
  ...
  router.put(
    '/:id',
    checkPermission(pool, 'Admin'),
    withPool(pool, activityTypeController.updateActivityType),
  );
  router.delete(
    '/:id',
    checkPermission(pool, 'Admin'),
    withPool(pool, activityTypeController.deleteActivityType),
  );
